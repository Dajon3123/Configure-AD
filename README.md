...
- Step 4 In This Step, i began by logging in to DC-1 as jane_admin and open PowerShell ISE as an administrator. Run the script to create new user accounts, then verify them in ADUC under the _EMPLOYEES OU.
